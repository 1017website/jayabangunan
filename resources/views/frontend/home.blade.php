...
<head>
  ...
  <script>
    ...
    })(window, document, 'script', 'dataLayer', '{{ $seo['seo_google_tag_manager'] }}');
  </script>
  @endif
...
<body>
  ...
  <nav id="navbar">
    ...
    <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $company['company_whatsapp'] ?? '6231567890') }}"
      class="nav-wa" target="_blank" style="visibility:hidden;">
      ...
      <span class="wa-label">Klik di sini</span>
    </a>
  ...
  <!-- VIDEOS -->
  @if(($showVideos ?? true) && isset($videos) && $videos->count() > 0)
    ...
    <div class="sec-inner">
      <div class="contact-left rv-l">
        ...
        <div class="cinfo-list">
          ...
          <div class="cinfo-item">
            <div>
              <a href="https://wa.me/{{ $company['company_whatsapp'] ?? '' }}" class="nav-wa" target="_blank">
