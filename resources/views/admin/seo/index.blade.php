...
<form method="POST" action="{{ route('admin.seo.update') }}" enctype="multipart/form-data">
  ...
  <div class="card" style="margin-bottom:24px;">
    ...
    <div class="card-bd">
      ...
      {{-- Setelah field Google Search Console --}}
      <div class="form-group" style="margin-top:16px;padding-top:16px;border-top:1px solid #2a3040;">
        <p style="font-size:11px;color:#64748b;text-transform:uppercase;letter-spacing:1px;font-weight:700;margin-bottom:16px;">📘 Meta Pixel (Facebook/Instagram Ads)</p>
        <div class="frow">
          <div class="fg">
            <label class="fl">Meta Pixel ID</label>
            <input type="text" name="settings[seo_meta_pixel]" class="fc"
              value="{{ $seo['seo_meta_pixel'] ?? '' }}"
              placeholder="1234567890123456">
            <div class="fhint">Hanya angka Pixel ID — contoh: 1234567890123456</div>
          </div>
          <div class="fg">
            <label class="fl">Google Tag Manager ID</label>
            <input type="text" name="settings[seo_google_tag_manager]" class="fc"
              value="{{ $seo['seo_google_tag_manager'] ?? '' }}"
              placeholder="GTM-XXXXXXX">
            <div class="fhint">Format: GTM-XXXXXXX</div>
          </div>
        </div>
      </div>
    </div>
