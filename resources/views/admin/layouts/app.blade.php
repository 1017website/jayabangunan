  ...
  <style>
    * {
    ...
    .fta:focus {
      outline: none;
      border-color: var(--red3);
      box-shadow: 0 0 0 3px rgba(192, 0, 28, .1);
    }
...
<body>
  ...
  <script>
    ...
    document.querySelectorAll('.sb-nav a').forEach(a => a.addEventListener('click', () => {
